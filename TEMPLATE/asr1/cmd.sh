...
# "qsub" (Torque/PBS.)
    ...
    export train_cmd="utils/pbs.pl"
    export cuda_cmd="utils/pbs.pl"
...
# Users can modify/add their own command options according to their cluster environments.
    ...
    export train_cmd="utils/queue.pl --mem 2G"
    export cuda_cmd="utils/queue-freegpu.pl --mem 2G --gpu 1 --config conf/queue.conf"
